...
export const metadata: Metadata = {
  ...
  description: "Comprehensive B-BBEE transformation consulting services designed to drive growth and profit.",
}

export default function ServicesPage() {
  return (
    <>
      {/* Hero Section - White, no logos */}
      <section className="relative w-full bg-white overflow-hidden">
        <div className="relative z-10 mx-auto w-full px-6 py-20 sm:px-10 sm:py-24 lg:px-16">
          ...
          <p className="mt-5 max-w-2xl text-base sm:text-lg text-slate-600 leading-relaxed">
            ...
            <span className="bg-[#FFCE10] px-1.5 py-0.5 font-medium text-white">practical, evidence-ready outcomes</span>{" "}
            that drive growth and scorecard results.
          </p>
              ...
              <div className="relative z-10 grid gap-6 lg:grid-cols-12 items-center">
                <div className="lg:col-span-8">
                  <h3 className="text-2xl sm:text-3xl font-bold">
                    Ready to transform your B-BBEE strategy?
                  </h3>
